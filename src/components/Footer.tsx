      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center mb-4">
              ...
              <span className="font-bold text-xl text-white">NorthScholarship</span>
            </Link>
            <p className="text-gray-400 text-sm">
              Find the best scholarships, colleges, and financial aid opportunities across the US and Canada.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/scholarships" className="text-gray-400 hover:text-white text-sm">All Scholarships</Link></li>
              <li><Link to="/scholarships?country=US" className="text-gray-400 hover:text-white text-sm">US Scholarships</Link></li>
              <li><Link to="/scholarships?country=Canada" className="text-gray-400 hover:text-white text-sm">Canadian Scholarships</Link></li>
              <li><Link to="/calculator" className="text-gray-400 hover:text-white text-sm">EMI Calculator</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500">
            © {new Date().getFullYear()} North Scholarship Compass. All rights reserved.
          </p>
